...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control
	 {
	     ...
	     * @return String
	     */
	    public function get_fonts( $amount = 133 )
	    {
	        $selectDirectory = get_stylesheet_directory(). '/fonts/google-fonts/';
	        $selectDirectoryInc = get_stylesheet_directory().'/inc/fonts/google-fonts/';
	        ...
	        if(file_exists($fontFile) && $cachetime < filemtime($fontFile))
	        {
	            ...
	            $googleApi = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyDQTmTmsnYHU0ya6tKAhMg9cHbIaeuJGi4';
